...
- `OKDiskCore` — local destination config, destination store initialization, JSONL metadata replay, rsync-style `tree/` mirroring, restore, deep verification, repair, destination tree pruning, and confirmed reconciliation.
